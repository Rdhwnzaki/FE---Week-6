...
function ModalPayment() {
  ...
  return (
    <>
      <button class="btn btn-danger myfont3" onClick={handleShow} style={{height: "50px",borderRadius: "40px",width:"350px"}}>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
            <div className="row align-items-center mb-3">
                ...
                <div className="col-4">
                <Checkbox {...label} sx={{color: red[800],'&.Mui-checked': {color: red[600],},}}/>
                </div>               
            </div>
            <div className="row align-items-center mb-3">
                <div className="col-4">
        ...
        <div className="row">
            ...
            <Button variant="danger" className='rounded-pill' style={{width:"180px"}} onClick={handleClose}>
          Buy
          </Button>
            </div>
        </div>
