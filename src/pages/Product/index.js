...
export default function Product() {
  ...
  return (
    <div>
      ...
      <div className="container bg-new mt-2 p-2 rounded mb-2 shadow">
        ...
        <div className="container d-flex flex-row">
          <div className="">
            <div
              className={`btn ${
                sortBy == "name_product" ? "btn-danger" : "btn-outline-danger"
              } ms-1`}
            ...
            <div
              className={`btn ${
                sortBy == "stock-product" ? "btn-danger" : "btn-outline-danger"
              } ms-3`}
            ...
            <div
              className={`btn ${
                sortBy == "price_product" ? "btn-danger" : "btn-outline-danger"
              } ms-3`}
          ...
          <div className="search ms-2">
            <input
              type="text"
              className="form-control myfont3 rounded-pill ms-5"
      ...
      {/* get data */}
      <table
        className="table table-striped table-hover container shadow"
        style={{ color: "black" }}
      >
        <thead>
          <tr>
        ...
        <tbody className="table-group-divider">
          {data.map((item, index) => (
            <tr
              key={index + 1}
              className={`${
                item.id_product === selected ? "bg-info" : "bg-white"
              }`}
              onClick={
                item.id_product === selected
                  ? () => setSelected(null)
                  : () => (setSelected(item.id_product), editForm(item))
              }
            >
              <td className="myfont3">{index + 1}</td>
