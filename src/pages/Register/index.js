...
export default function Register() {
  ...
  const postRegis = (e)=>{
    ...
    let data = {
      email_user,password_user,fullname_user
    }
  ...
  return (
    ...
    <div
      ...
      id="container-login"
      >
      <button type="submit" className="btn btn-lg btn round btn-danger mt-4" id="button-login">
        <h5 className="myfont3" style={{marginTop:"10px"}}>Register</h5>
      </button>
